...
func CreateMachine(ctx context.Context, opts MachineOptions) (*firecracker.Machine, error) {
	...
	cfg := firecracker.Config{
		...
		KernelArgs:      "console=ttyS0 noapic reboot=k panic=1 pci=off overlay_root=vdb i8042.noaux i8042.nomux i8042.nopnp i8042.dumbkbd init=/sbin/overlay-init-systemd",
