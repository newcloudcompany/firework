...
FC_BRIDGE_IPv4_ADDR_CIDR="10.0.0.1/16"
FC_BRIDGE_IPv4_ADDR="10.0.0.1"
DHCP_RANGE_START="10.0.0.2"
DNSMASQ_FC_CONF="/etc/dnsmasq.d/firecracker.conf"

mkdir -p /etc/systemd/system/dnsmasq@firecracker.service.d/
mkdir -p /etc/dnsmasq.d/
cp config/dnsmasq@.service /etc/systemd/system/
...
dhcp-range=$DHCP_RANGE_START,10.0.255.254,255.255.0.0,12h
...
systemctl restart dnsmasq@firecracker
